    ...
    return NextResponse.json(
      {
        ...
        // DIAGNOSTIC TEMPORAIRE (12/09, round 2) : toujours EROFS après ajout
        // de NEXT_PUBLIC_SUPABASE_URL + redeploy — à élucider. Routes déjà
        // protégées par session admin, aucune fuite à un visiteur non connecté.
